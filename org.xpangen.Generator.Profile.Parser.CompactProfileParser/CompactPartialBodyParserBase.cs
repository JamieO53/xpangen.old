...
namespace org.xpangen.Generator.Profile.Parser.CompactProfileParser
{
    public abstract class CompactPartialBodyParserBase : GenBase
    {
        ...
        internal void ScanPartialBody(int classId, GenSegBody body, GenContainerFragmentBase parentSegment,
            GenContainerFragmentBase parentContainer, out TokenType t)
        {

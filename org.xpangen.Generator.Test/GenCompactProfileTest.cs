...
namespace org.xpangen.Generator.Test
{
    ...
    public class GenCompactProfileTest : GenProfileFragmentsTestBase
    {
        ...
        public void TextProfileTest()
        {
            ...
            Assert.AreEqual(txt, GenFragmentExpander.Expand(profile, d, ((GenFragment) profile).GenObject, profile.Fragment), "Original text expected");
        }
        ...
        public void SegmentProfileTest()
        {
            ...
            Assert.AreEqual("Class,SubClass,Property,", GenFragmentExpander.Expand(profile, d, ((GenFragment) profile).GenObject, profile.Fragment), "Class list expected");
        }
        ...
        public void SegmentTextProfileTest()
        {
            ...
            Assert.AreEqual(txt,
                            profile.Body.ProfileText(
                                ProfileFragmentSyntaxDictionary.ActiveProfileFragmentSyntaxDictionary));
            Assert.AreEqual("Some text Class,SubClass,Property, some more text", GenFragmentExpander.Expand(profile, d, ((GenFragment) profile).GenObject, profile.Fragment),
        ...
        public void BlockProfileTest()
        {
            ...
            Assert.AreEqual(txt,
                            profile.Body.ProfileText(
                                ProfileFragmentSyntaxDictionary.ActiveProfileFragmentSyntaxDictionary));
            Assert.AreEqual("Block text", GenFragmentExpander.Expand(profile, d, ((GenFragment) profile).GenObject, profile.Fragment), "Block text expected");
        }
        ...
        public void LookupProfileTest()
        {
            ...
            Assert.AreEqual(txt,
                            profile.Body.ProfileText(
                                ProfileFragmentSyntaxDictionary.ActiveProfileFragmentSyntaxDictionary));
            Assert.AreEqual("Class{SubClass,Property},SubClass{},Property{}", GenFragmentExpander.Expand(profile, d, ((GenFragment) profile).GenObject, profile.Fragment),
        ...
        public void NoMatchProfileTest()
        {
            ...
            Assert.AreEqual(txt,
                            profile.Body.ProfileText(
                                ProfileFragmentSyntaxDictionary.ActiveProfileFragmentSyntaxDictionary));
            Assert.AreEqual("Class{},SubClass{},Property{}", GenFragmentExpander.Expand(profile, d, ((GenFragment) profile).GenObject, profile.Fragment), "Class/Subclass list expected");
        }
        ...
        public void ExistenceConditionProfileTest()
        {
            ...
            Assert.AreEqual(txt,
                            profile.Body.ProfileText(
                                ProfileFragmentSyntaxDictionary.ActiveProfileFragmentSyntaxDictionary));
            Assert.AreEqual("Name exists NoName does not exist ", GenFragmentExpander.Expand(profile, d, ((GenFragment) profile).GenObject, profile.Fragment),
        ...
        public void LiteralConditionProfileTest()
        {
            ...
            Assert.AreEqual("Class name equals Class " +
                ...
                GenFragmentExpander.Expand(profile, d, ((GenFragment) profile).GenObject, profile.Fragment), "Comparison conditions expected");
        }
        ...
        public void NoParamFunctionProfileTest()
        {
            ...
            Assert.AreEqual(txt,
                            profile.Body.ProfileText(
                                ProfileFragmentSyntaxDictionary.ActiveProfileFragmentSyntaxDictionary));
            Assert.AreEqual(DateTime.Today.ToLongDateString(), GenFragmentExpander.Expand(profile, d, ((GenFragment) profile).GenObject, profile.Fragment),
        ...
        public void SingleParamFunctionProfileTest()
        {
            ...
            Assert.AreEqual(txt,
                            profile.Body.ProfileText(
                                ProfileFragmentSyntaxDictionary.ActiveProfileFragmentSyntaxDictionary));
            Assert.AreEqual("\r\n //File: filename.txt", GenFragmentExpander.Expand(profile, d, ((GenFragment) profile).GenObject, profile.Fragment), "Function output expected");
        }
        ...
        public void FunctionProfileTest()
        {
            ...
            Assert.AreEqual(txt,
                            profile.Body.ProfileText(
                                ProfileFragmentSyntaxDictionary.ActiveProfileFragmentSyntaxDictionary));
            Assert.AreEqual("5 10", GenFragmentExpander.Expand(profile, d, ((GenFragment) profile).GenObject, profile.Fragment), "Function output expected");
        }
